            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {technologies.map((tech, index) => (
                        ...
                        >
                            {/* Icon */}
                            <div className={`w-16 h-16 rounded-xl ${tech.color} flex items-center justify-center mb-6 transform group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                ...
                <div className="mt-16 text-center">
                    <div className="inline-block bg-primary p-8 rounded-3xl shadow-2xl">
