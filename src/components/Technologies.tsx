            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-lg text-slate-600">
                        We use cutting-edge technologies to build modern, scalable, and high-performance solutions for your business.
                    </p>
                </div>
                ...
                <div className="mt-16 text-center">
                    <div className="inline-block bg-gradient-to-r from-primary via-primary-light to-primary p-8 rounded-3xl shadow-2xl">
                        ...
                        <p className="text-white/90 mb-6 max-w-2xl mx-auto">
                            Let's transform your ideas into reality with our expert team and cutting-edge technology stack.
                        </p>
                        <a
                            href="#contact"
