...
export default function Hero() {
    ...
    return (
        <section id="home" className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-50">
            <div className="absolute top-0 right-0 -z-10 w-1/2 h-full opacity-10 blur-3xl bg-secondary rounded-full" />
            <div className="absolute bottom-0 left-0 -z-10 w-1/2 h-full opacity-10 blur-3xl bg-primary rounded-full" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <motion.div
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 text-primary font-medium text-sm border border-primary/10 backdrop-blur-sm"
                        ...
                        >
                            <motion.a
                                href="#contact"
                                className="inline-flex justify-center items-center gap-2 bg-secondary hover:bg-secondary-dark text-slate-900 px-8 py-4 rounded-full font-semibold transition-all shadow-lg"
                    ...
                    >
                        ...
                        <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center">
                            ...
                            >
                                <div className="absolute inset-0 bg-secondary rounded-[2rem] rotate-45 blur-xl opacity-10 animate-pulse" />
                            ...
                            {[
                                { icon: Code2, label: 'Custom Apps', pos: '-top-4 -left-4', color: 'bg-secondary' },
                                { icon: Smartphone, label: 'Mobile First', pos: 'top-8 -right-12', color: 'bg-primary' },
                                { icon: Database, label: 'Data Science', pos: '-bottom-8 -right-8', color: 'bg-secondary' },
                                { icon: Globe, label: 'Cloud Solutions', pos: 'bottom-12 -left-12', color: 'bg-primary' }
                            ].map((node, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`p-4 rounded-3xl ${node.color} shadow-lg border border-white/10 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6`}>
                                        ...
                                        <div className="absolute top-1/2 left-1/2 w-32 h-[1px] bg-secondary/20 -z-10 origin-left"
                            ...
                            />
                            <div className="absolute inset-0 bg-secondary/5 blur-3xl -z-30 opacity-30" />
                        </div>
                    </motion.div>
                </div>
            </div>
