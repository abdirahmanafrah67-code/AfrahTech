...
export default function Contact() {
    ...
    return (
        <section id="contact" className={`section-padding bg-slate-50 ${isPage ? 'pt-32 min-h-screen' : ''}`}>
                    ...
                    <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-200">
                        <form className="space-y-6" onSubmit={handleSubmit}>
                            ...
                            <button
                                ...
                                className="w-full bg-secondary hover:bg-secondary-dark text-primary font-bold py-4 rounded-xl transition-all shadow-lg shadow-secondary/30 hover:shadow-secondary/50 flex justify-center items-center gap-2 transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isSubmitting ? (
                                    <>
