            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="relative">
                        ...
                        <div className="relative bg-slate-50 rounded-3xl p-8 sm:p-12 overflow-hidden shadow-2xl border border-slate-200">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>

                            <h3 className="text-2xl font-bold mb-8 relative z-10 text-slate-900">Our Mission & Vision</h3>
                            <div className="space-y-8 relative z-10">
                                <div className="flex gap-4">
                                    <div className="bg-secondary/10 p-3 rounded-xl h-fit border border-secondary/20 shadow-lg">
                                        <Target className="h-6 w-6 text-secondary" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-lg mb-2 text-slate-900">Mission</h4>
                                        <p className="text-slate-600 text-sm leading-relaxed">To empower businesses across East Africa with innovative digital solutions that drive growth and transformation.</p>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <div className="bg-primary/10 p-3 rounded-xl h-fit border border-primary/20 shadow-lg">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-lg mb-2 text-slate-900">Innovation</h4>
                                        <p className="text-slate-600 text-sm leading-relaxed">We stay ahead of technology trends to deliver cutting-edge solutions that give you a competitive advantage.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
